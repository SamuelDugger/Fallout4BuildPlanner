  ...
  strength: [
    {
      ...
      ranks: [
        ...
        "Punching attacks now do 60% more damage. Unarmed Power Attacks have a chance to cripple limbs.",
        "Punching attacks now do 80% more daamge. Unarmed Power Attacks have a better chance to cripple limbs.",
        "Punching attacks now do double damage. Criticals in VATS will paralyze opponents.",
      ],
      tldr: "Unarmed damage",
    },
    {
      ...
      ranks: [
        ...
        "You now do 40% more melee weapon damage and gain a chance to disarm opponents.",
        "You now do 60% more melee weapon damage and gain an increased chance to disarm opponents.",
        "You now do 80% more melee weapon damage and hit all targets in front of you.",
        "You now do double damage with a melee weapon, and gain a chance to cripple opponents, or grand slam their heads clean off!",
      ],
    ...
    },
    {
      ...
      ranks: [
        ...
        "Gain access to Rank 2 armor mods.",
        "Gain access to Rank 3 armor mods.",
        "Gain access to Rank 4 armor mods.",
      ],
      tldr: "Armor mods",
    },
    {
      ...
      ranks: [
        ...
        "Gain access to Rank 4 melee weapon mods.",
      ],
      tldr: "Melee Weapon mods",
    },
    {
      name: "Heavy Gunner",
      ...
      ranks: [
        ...
        "Heavy guns now do 80% more damage and have a chance to stagger opponents.",
    ...
    },
    {
      ...
      ranks: [
        ...
        "[Far Harbor] When overencumbered, running costs 50% less action points.",
      ],
      tldr: "Carry Weight",
    },
    {
      ...
      ranks: [
        ...
        "[Nuka World] Hip-fire damage is improved when firing any gun.",
      ],
      tldr: "Hip-fire accuracy",
    },
    {
      name: "Basher",
      levels: [2, 5, 14, 26],
      ranks: [
        ...
        "Gun bashing now does 50% more damage and possibly cripples opponents.",
        "Gun bashing now does 75% more daamge and has an increased chance to cripple opponents.",
        "Gun bashing does double damage and has an increased chance to cripple your opponent. It may also inflict a Critical Hit.",
      ],
      tldr: "Gun Bash damage",
    },
    {
      name: "Rooted",
      levels: [2, 22, 43],
      ranks: [
        ...
        "When standing still, you now gain +50 Damage Resistance and your melee and unarmed attacks deal 50% more daamge.",
        "While standing still, you may automatically disarm enemies thatr use melee weapons against you.",
      ],
      tldr: "Melee bonus for not moving",
    },
    {
      name: "Pain Train",
      levels: [2, 24, 50],
      ranks: [
        "Choo choo! All aboard! While wearing Power Armor, sprinting into enemies hurts and staggers them. Robots and oversized enemies are immune to stagger.",
        "Sprinting into enemies while wearing Power Armor now causes severe damage and a more powerful stagger.",
  ...
  perception: [
    ...
    },
    {
      ...
      ranks: [
        ...
        "Attacks with non automatic rifles now do double damage and ignore 30% of a target's armor. They have a slightly higher chance of crippling a limb.",
      ],
    ...
    },
    {
      ...
      levels: [2, 14],
      ranks: [
        "To defeat your enemies, know their weaknesses! You can view a target's specific damage resistances in VATS.",
        "[Nuka World] Knowing their weaknesses lets you attack more efficiently. 5% increase to hit chance and damage dealt to VATS targets.",
      ],
      tldr: "See enemy weaknesses",
    },
    {
      name: "Locksmith",
      levels: [2, 7, 18, 41],
    ...
    },
    {
      ...
      ranks: [
        ...
        "Your explosives now do 50% more damage, and grenades gain a throwing arc.",
        "Your explosives now do 75% more damage and affect a larger area.",
        "Your explosives now do double damage. Mines and grenades shot in VATS explode for double damage.",
      ],
    ...
    },
    {
      ...
      ranks: [
        ...
        "You now have +3 Intelligence and Perception between the hours of 6:00 p.m. and 6:00 a.m., and night vision when sneaking.",
        "[Far Harbor] You have 30 extra health between the hours of 6:00 PM and 6:00 AM.",
      ],
    ...
    },
    {
      ...
      ranks: [
        ...
        "Non-automatic, scoped rifles gain +25% accuracy to head shots in VATS.",
      ],
      tldr: "Scoped effectiveness",
    },
    {
      name: "Penetrator",
      levels: [2, 28],
      ranks: [
        "There's no place to hide! In VATS you can target an enemy's body parts that are blocked by cover, with a decrease in accuracy.",
        "In VATS when you target an enemy's body parts that are blocked by cover, there is no decrease in accuracy.",
      ],
    ...
    },
    {
      ...
      levels: [2, 26, 50],
      ranks: [
        "Stay focused! In VATS every attack on the same body part gains +10% accuracy.",
        "In VATS every attack on the same body part gains +15% accuracy.",
        "In VATS every attack on the same body part gains +20% accuracy and does 20% more damage.",
      ],
  ...
  endurance: [
    ...
    },
    {
      ...
      ranks: [
        ...
        "[Far Harbor] You now have +40 Radiation Resistance.",
      ],
    ...
    },
    {
      ...
      levels: [2, 13, 26],
      ranks: [
        "Your skeleton has been infused with indestructible metal, reducing limb damage by 30%, Your limb damage is now reduced by 60%.",
    ...
    },
    {
      ...
      ranks: [
        ...
        "Eating human, Ghoul, or Super Mutant corpses restores a significant amount of health.",
      ],
    ...
    },
    {
      ...
      ranks: [
        ...
        "[Nuka World] Rad damage will now begin to slowly heal, restoring health in the process.",
      ],
    ...
    },
    {
      ...
      levels: [2, 27, 50],
      ranks: [
        "Catch some rays! Gain +2 to Strength and Endurance between the hours of 6:00 a.m. and 6:00 p.m.",
  ...
  charisma: [
    {
      ...
      ranks: [
        ...
        "Buying and selling prices at vendor are now much better.",
        "You can invest a total of 500 caps to raise a store's bounty capacity.",
      ],
      tldr: "Better prices",
    },
    {
      ...
      levels: [2, 7, 22],
      ranks: [
        "You're charming... and dangerous. Women/Men suffer +5% damage in combat, and are easier to persuade in dialogue.",
        "Women/Men now suffer +10 damage in combat, and are even easier to persuade in dialogue. They are also easier to pacify with the Intimidation perk.",
    ...
    },
    {
      ...
      ranks: [
        ...
        "[Far Harbor] When adventuring without a companion, you have 25 more action points.",
      ],
    ...
    },
    {
      ...
      ranks: [
        ...
        "[Nuka World] When adventuring with your dog, you take 10% less damage.",
      ],
    ...
    },
    {
      ...
      ranks: [
        ...
        "Your companion resists more daamge in combat, and can't be harmed by your attacks.",
        "Your companion can carry more items.",
      ],
      tldr: "Companion enhanced",
    },
    {
      name: "Wasteland Whisperer",
      levels: [2, 21, 49],
      ranks: [
        "Master the post-apocalypse! With your gain, aim at any Wasteland creature below your level and gain a chance to pacify it.",
        "When you successfully pacify a Wasteland creature, you can incite it to attack.",
        "When you succesffully pacify a Wasteland creature, you can give it specific commands.",
      ],
    ...
    },
    {
      ...
      levels: [2, 23, 50],
      ranks: [
        "Time to show everyone who's boss! With your gun, aim at any human below your level and gain a chance to pacify them.",
  ...
  intelligence: [
    {
      ...
      ranks: [
        ...
        "[Nuka World] Gain +2 to Perception.",
      ],
      tldr: "Improve Pip-Boy map notes",
    },
    {
      name: "Medic",
      levels: [2, 18, 30, 49],
      ranks: [
        "Is there a doctor in the house? Stimpacks restore 40% of lost health, and RadAway removes 40% of radiation.",
        "Stimpaks now restore 60% of lost Health, and RadAway removes 60% of radiation.",
        "Stimpacks now restore 80% of lost health, and RadAway removes 80% of radiation",
        "Stimpacks and RadAway restore all lost health and radiation, and work much more quickly.",
      ],
    ...
    },
    {
      ...
      ranks: [
        ...
        "You gain access to Rank 4 gun mods. Rank 49",
      ],
      tldr: "Gun Mods",
    },
    {
    ...
    },
    {
      ...
      ranks: [
        ...
        "You can salvage rare components like circuitry, nuclear material, and fiberoptics when scrapping weapons and armor. Items with favorited components are highlighted.",
        "[Far Harbor] You get more from salvaging.",
      ],
      tldr: "Salvage rare components",
    },
    {
      name: "Science",
      levels: [2, 17, 28, 41],
      ranks: [
        "Take full advantage of advaned technology with access to ase level and Rank 1 high-tech mods.",
    ...
    },
    {
      ...
      tldr: "Chems last longer",
    },
    {
      name: "Robotics Expert",
      levels: [2, 19, 44],
      ranks: [
        "Machines will always serve humans, if you have anything to say about it. Hack a robot, and gain a chance to power it on or off, or initate a self-destruct.",
    ...
    },
    {
      ...
      levels: [2, 14, 26],
      ranks: [
        "You've learned to split the atom... and command it. Radiation weapon do 50% more damage and Fusion Cores last an extra 25% longer.",
    ...
    },
    {
      ...
      ranks: [
        ...
        "You now gain 40 more Damage Resistance and do 40% more damage while Nerd Rage is in effect. Kills you make while enraged restores some lost Health.",
      ],
  ...
  agility: [
    {
      ...
      ranks: [
        ...
        "Non-automatic pistols do 40% more damage and have increased range.",
    ...
    },
    {
      ...
      ranks: [
        ...
        "Your automatic weapons now do 40% more damage, with improved hip fire accuracy.",
    ...
    },
    {
      ...
      ranks: [
        ...
        "You are now 30% harder to detect when sneaking, and no longer trigger floor-based traps.",
        "You are now 40% harder to detect when sneaking, and no longer trigger enemy mines.",
        "You are now 50% harder to detect when sneaking, and running no longer adversely affects stealth.",
    ...
    },
    {
      ...
      ranks: [
        ...
        "[Far Harbor] Your Action Points now regenerate 75% faster.",
      ],
      tldr: "Action Point regeneration",
    },
    {
      name: "Moving Target",
      levels: [2, 24, 44],
    ...
    },
    {
      ...
      ranks: [
        ...
        "Your ranged attacks do 3x normal damage and your melee sneak attacks do 5x normal damage.",
        "Your ranged attacks so 3.5x normal damage and your melee sneak attacks do 10x normal damage.",
      ],
      tldr: "Sneak Attack bonuses",
    },
    {
      name: "Quick Hands",
      levels: [2, 28, 40],
      ranks: [
        ...
        "[Nuka World] Quick and efficient. You gain 10 additional Action Points.",
      ],
    ...
    },
    {
      ...
      ranks: [
        ...
        "VATS melee distance is increased even more, and the farther the Blitz distance, the greater the damage.",
      ],
      tldr: "Melee distance increased",
    },
    {
      name: "Gun Fu",
      levels: [2, 26, 50],
      ranks: [
        "You've learned to apply ancient martial arts to gunplay! Do 25% more damage to your second VATS target and beyond.",
        "In VATS you do 50% more damage to your third target and beyond.",
        "In VATS you instantly do a Critical hit against your fourth target and beyond.",
      ],
  ...
  luck: [
    {
      ...
      levels: [2, 5, 25, 40],
      ranks: [
        "You've learned to discover the Wasteland's hidden wealth, and find more bottle caps in containers.",
    ...
    },
    {
      ...
      levels: [2, 7, 24, 37],
      ranks: [
        "You know just how to scavenge to keep the fight going, and find more ammunition in containers.",
        "You find even more ammunition in containers.",
        "You find even more ammunition in containers.",
        "You find even more ammuntion in containers.",
      ],
      tldr: "Find more Ammo",
    },
    {
      ...
      ranks: [
        ...
        "You can now inflict +15% damage in combat.",
    ...
    },
    {
      ...
      ranks: [
        ...
        "The Mysterious Stranger appears more often in VATS.",
        "The Mysterious Stranger appears more often in VATS. When he kills an opponent, there is a chance your critical meter gets filled.",
        "[Nuka World] The Mysterious Stranger appears more often in V.A.T.S. When he kills an opponent, there is a high chance your Critical meter gets filled.",
      ],
    ...
    },
    {
      ...
      levels: [2, 11, 34],
      ranks: [
        "You're not stupid! Just... different. Randomly recieve 3x XP from any action, the lower your Intelligence, the greater the chance.",
        "You now randomly recieve 5x XP from any action. The lower your Intelligence, the greater the chance.",
    ...
    },
    {
      ...
      levels: [2, 15, 40],
      ranks: [
        "Advanced training for enhanced combat effectiveness! Criticals do 50% more damage.",
        "Your criticals now do twice as much damge.",
        "Your criticals now do 2.5x as much extra damage.",
      ],
    ...
    },
    {
      ...
      levels: [2, 17, 43, 50],
      ranks: [
        "You're a patient battlefield tactician, and can save a Critical Hit, to be used in VATS, when your need it most.",
        "You can now save 2 Critical Hits, to be used in VATS, when you need them most.",
        "You can now save 3 Critical Hits, to be used in VATS when you need them most. Banking a Critical has a chance to save an additional Critical.",
        "[Far Harbor] You can now save 4 Critical Hits, to be used in V.A.T.S. when you need them the most.",
      ],
    ...
    },
    {
      ...
      ranks: [
        ...
        "Any kill in VATS now has a 25% chance to restore all Action Points.",
        "Any kill in VATS now has a 35% chance to restore all Action Points and refill your Critical Meter.",
      ],
    ...
    },
    {
      ...
      ranks: [
        ...
        "Each hit in VATS now has an even better chance of filling your Critical Meter.",
        "Each hit in VATS now has a very good chance of filling your Critical Meter.",
        "Each hit in VATS now has an excellent chance of filling your Critical Meter.",
      ],
    ...
    },
    {
      ...
      levels: [2, 29, 50],
      ranks: [
        "What goes around comes around! An enemy's ranged attack will sometimes richochet back and instantly kill them. The close you are to death, the higher the chance.",
        "There's an increasd chance that an enemy's shot will ricochet back and kill them.",
        "When an enemy's shot ricochets back and kills them, there's a chance your Critical meter gets filled.",
      ],
...
function exportLevels() {
  ...
  // Extract data from displayed levels
  for (var i = 0; i < character.level.length; i++) {
    if (character.level[i] !== undefined) {
      data += i + 2 + "," + character.level[i].name + "\n";
    } else {
      data += i + 2 + ",Free\n";
    }
  }
  ...
  link.download = "character_levels.csv";
  link.click();
}
...
function getPerk(perk, stat) {
  ...
  //    }
  perk.splice(
    findInPerk(perk, perk[0].special, perk[0].rank, perk[0].levels),
    1
  );
}
...
function calcLevel() {
  ...
  //Use for prioritizing level of all perks first

  //sortPerkArray();
  //Use for prioritizing priority value first.
...
function calcRanks(startingPoints) {
...
function toggleCharacterPoints() {
  if (character.points === 21) {
    character.points = 29;
  ...
  // Rebuild specials display after toggling points
  buildSpecial();
}

function toggleTwoPoints() {
  if (character.points === 21) {
    character.points = 23;
    totalPoints = character.points;
  } else {
...
function buildSpecial() {
  calcRanks(character.points);
  $("#char").html(
    "<div class='charRow'><span class='specLevel'>Starting Special</span></div>" +
      ...
      character.points +
      "</span><span class='levelBox'>- " +
      (character.points - Number(character.points)) +
      "</span></div>"
  );
}

function buildSpecials() {
  calcRanks(totalPoints);
  $("#char").html(
    "<div class='charRow'><span class='specLevel'>Starting Special</span></div>" +
      "<div class='charRow'><span class='specLevel'>Strength</span><span class='levelBox'>" +
      character.strength +
...
function buildPerkList() {
  ...
  var temp = "";
  $("#perk").html(
    "<div class='perkRow'><span class='levelBox'>Pri</span><span class='specLevel'>Special</span><span class='levelBox'>Req</span><span class='perkName'>Perk</span><span class='perkLevels'>LVL</span><span class='tldr'>Description</span></div>"
  );
  ...
  for (var i = 0; i < character.perkArray.length; i++) {
    $("#perk").html(
      $("#perk").html() +
        ...
        " levels=" +
        character.perkArray[i].levels +
        " />" +
        "</span>" +
        "<span class='specLevel'>" +
        character.perkArray[i].special +
        "</span>" +
        "<span class='levelBox'>" +
        character.perkArray[i].rank +
...
function getPriority(special, rank) {
  ...
  if (character.perkArray.length > 0) {
    ...
    if (pri >= 0) priority = Number(character.perkArray[pri].priority);
    else priority = Number(findHighestPriority()) + 1;
  }
...
function click(a) {
  ...
  if (a.checked) {
    ...
    if (findInPerk(character.perkArray, p[0], rank, perkLevel) >= 0) {
      character.perkArray.splice(
        findInPerk(character.perkArray, p[0], rank, perkLevel),
        1
      );
    }
  }
...
$(document).ready(function () {
  ...
  for (var i = 0; i < perks.strength.length; i++) {
    ...
    temp +=
      ...
      "</span>" +
      getPerks(perks.strength[i], "strength", i) +
      "</span>";
    temp +=
      "<span class='perk'><span>" +
      perks.perception[i].name +
      "</span>" +
      getPerks(perks.perception[i], "perception", i) +
      "</span>";
    temp +=
      "<span class='perk'><span>" +
      perks.endurance[i].name +
      "</span>" +
      getPerks(perks.endurance[i], "endurance", i) +
      "</span>";
    temp +=
      "<span class='perk'><span>" +
      perks.charisma[i].name +
      "</span>" +
      getPerks(perks.charisma[i], "charisma", i) +
      "</span>";
    temp +=
      "<span class='perk'><span>" +
      perks.intelligence[i].name +
      "</span>" +
      getPerks(perks.intelligence[i], "intelligence", i) +
      "</span>";
    temp +=
      "<span class='perk'><span>" +
      perks.agility[i].name +
      "</span>" +
      getPerks(perks.agility[i], "agility", i) +
      "</span>";
    temp +=
      "<span class='perk'><span>" +
      perks.luck[i].name +
      "</span>" +
      getPerks(perks.luck[i], "luck", i) +
      "</span>";
    temp += "</div>";
  }
  ...
  $("#perkSelect").ready(function () {
    $("input[type='checkbox']").change(function () {
      ...
      $("label.checkbox:hover ~ label.checkbox > input[type='checkbox']").prop(
        "checked",
        true
      );
